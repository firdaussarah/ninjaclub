                              ...
                              <div>
                                 <main id="main">
                                    <section id="menu" class="menu">
                                       <div class="container">
                                          <h1 class="mt-4">Gallery List</h1>

                                          <a href="create_gallery.php" class="btn btn-secondary mb-3">Add New Gallery</a>
                                          <div style="overflow-x: auto;">
                                             <table class="table table-striped" style="width: 900px" ;>
                                                ...
                                                <tbody>
                                                   <?php while ($galeri = mysqli_fetch_assoc($galleryQuery)): ?>
                                                      <tr>
                                                         <td><img src="../<?php echo $galeri['image']; ?>" width="100"></td>
                                                         <td><?php echo $galeri['title']; ?></td>
                                                         <td><?php echo $galeri['description']; ?></td>
                                                         <td><?php echo $galeri['category']; ?></td>
                                                         <td>
                                                            <a href="edit_gallery.php?id=<?php echo $galeri['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                            <a href="delete_gallery.php?id=<?php echo $galeri['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                                                         </td>
                                                      </tr>
                                                   <?php endwhile; ?>
                                                </tbody>
                                 ...
                                 <div class="container-fluid">
                                    <div class="footer">
                                       <p>Copyright © 2025 Designed by Ninja Club Bogor. All rights reserved.
                                       </p>
                                    </div>
                                 </div>
                              </div>
