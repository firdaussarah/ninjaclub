                              ...
                              <div>
                                 ...
                                 <section>
                                    ...
                                    <div class="container">
                                       ...
                                       <a href="create_members.php" class="btn btn-secondary mb-3">Add New Member</a>
                                             ...
                                             <tbody>
                                                <?php while ($row = mysqli_fetch_assoc($team)): ?>
                                                   <tr>
                                                      ...
                                                      <td>
                                                         <a href="edit_members.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                                         <a href="delete_members.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure?')">Delete</a>
                                                      </td>
                                                   </tr>
                                                <?php endwhile; ?>
                                             </tbody>
