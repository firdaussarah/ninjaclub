         ...
         <nav id="sidebar">
            <div class="sidebar_blog_1">
               <div class="sidebar-header">
                  <div class="">
                     <!-- <a href="/index.html"><img class="logo_icon img-responsive" src="../assets/img/favicon.png" alt="#" /></a> -->
                  </div>
               </div>
                                 ...
                                 <main id="main">
                                    <section id="menu" class="menu">
                                       <div class="container">
                                          ...
                                          <?php endif; ?>
                                          <a href="create_event.php" class="btn btn-secondary mb-3">Add New Event</a>
                                                ...
                                                <tbody>
                                                   <?php while ($row = $result->fetch_assoc()): ?>
                                                      <tr>
                                                         ...
                                                         <td>
                                                            <a href="edit_event.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm me-2">Edit</a>
                                                            <a href="delete_event.php?id=<?= $row['id'] ?>" onclick="return confirm('Are u sure?')" class="btn btn-danger btn-sm">Delete</a>
                                                         </td>
